...
def test(model, test_loader, criterion):
    ...
    for test_inputs, test_labels in test_loader:
        ...
        test_inputs = test_inputs.resize_(test_inputs.size()[0], 784)
        ...
        test_correct = (test_labels.data == ps.max(1)[1])
...
def train(model, train_loader, test_loader, criterion, optimizer, epochs):
    ...
    for e in range(epochs):  
        for train_inputs, train_lables in train_loader:
            train_inputs.resize_(train_inputs.size()[0], 784)
            ...
            optimizer.zero_grad()                # learing previous gradients
